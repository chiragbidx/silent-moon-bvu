        ...
        <aside className="hidden w-[264px] shrink-0 border-r bg-card/50 md:flex md:flex-col">
          <div className="p-5">
            <div className="flex items-center gap-2.5">
              <div className="grid size-8 place-items-center rounded-lg bg-primary text-primary-foreground text-base font-bold shadow-sm">
                CP
              </div>
              {/* Dashboard Text Logo */}
              <span className="font-semibold tracking-tight text-primary">ClientPilot</span>
            </div>
          </div>
